    ...
    public class OnnxModelConfigurator<TFeature> where TFeature : class
    {
        ...
        private ITransformer SetupMlNetModel(IOnnxModel onnxModel)
        {
            ...
            var pipeline = _mlContext.Transforms
                            .ApplyOnnxModel(modelFile: onnxModel.ModelPath,
                            outputColumnNames: onnxModel.ModelOutput, 
                            inputColumnNames: onnxModel.ModelInput, gpuDeviceId: hasGpu ? 0 : (int?)null);
